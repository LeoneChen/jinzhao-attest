...
# OPENSOURCE-CLEANUP SUB git@gitlab.alipay-inc.com:secretflow https://github.com/secretflow
SECRETFLOW_GIT = "git@gitlab.alipay-inc.com:secretflow"
...
def _rules_foreign_cc():
    maybe(
        ...
        urls = [
            "https://antsys-nebula-archive.cn-hangzhou-alipay-b.oss-cdn.aliyun-inc.com/third_party/rules_foreign_cc-0.7.1.tar.gz",
...
def _com_github_grpc_grpc():
    maybe(
        ...
        patch_args = ["-p1"],
        urls = [
            "{}/grpc-1.45.2.tar.gz".format(DEPS_FAST_MIRROR),
...
def _com_github_rules_proto_grpc():
    maybe(
        ...
        urls = [
            "{}/rules_proto_grpc-3.1.1.tar.gz".format(DEPS_FAST_MIRROR),
...
def _com_github_openssl_openssl():
    maybe(
        ...
        urls = [
            "https://antsys-nebula-archive.cn-hangzhou-alipay-b.oss-cdn.aliyun-inc.com/third_party/OpenSSL_1_1_1l.tar.gz",
...
def _com_github_madler_zlib():
    maybe(
        ...
        type = ".tar.gz",
        urls = [
            "https://antsys-nebula-archive.cn-hangzhou-alipay-b.oss-cdn.aliyun-inc.com/third_party/zlib-1.2.11.tar.gz",
